...
module.exports = createProxy("C:\\Users\\Ahmed\\Downloads\\project_next13_car_showcase-main\\node_modules\\next\\dist\\client\\components\\app-router.js");
 //# sourceMappingURL=app-router.js.map
...
/* unused reexport */ __webpack_require__(53)
...
var use_computed = __webpack_require__(6570);
...
var use_watch = __webpack_require__(2097);
...
var ke=(e=>(e[e.Open=0]="Open",e[e.Closed=1]="Closed",e))(ke||{}),we=(e=>(e[e.Single=0]="Single",e[e.Multi=1]="Multi",e))(we||{}),Ue=(e=>(e[e.Pointer=0]="Pointer",e[e.Other=1]="Other",e))(Ue||{}),Ne=(n=>(n[n.OpenCombobox=0]="OpenCombobox",n[n.CloseCombobox=1]="CloseCombobox",n[n.GoToOption=2]="GoToOption",n[n.RegisterOption=3]="RegisterOption",n[n.UnregisterOption=4]="UnregisterOption",n[n.RegisterLabel=5]="RegisterLabel",n))(Ne||{});function re(t,l=e=>e){let e=t.activeOptionIndex!==null?t.options[t.activeOptionIndex]:null,r=(0,focus_management/* sortByDomNode */.z2)(l(t.options.slice()),b=>b.dataRef.current.domRef.current),i=e?r.indexOf(e):null;return i===-1&&(i=null),{options:r,activeOptionIndex:i}}let He={[1](t){var l;return(l=t.dataRef.current)!=null&&l.disabled||t.comboboxState===1?t:{...t,activeOptionIndex:null,comboboxState:1}},[0](t){var e;if((e=t.dataRef.current)!=null&&e.disabled||t.comboboxState===0)return t;let l=t.activeOptionIndex;if(t.dataRef.current){let{isSelected:r}=t.dataRef.current,i=t.options.findIndex(b=>r(b.dataRef.current.value));i!==-1&&(l=i)}return{...t,comboboxState:0,activeOptionIndex:l}},[2](t,l){var i,b,n,d;if((i=t.dataRef.current)!=null&&i.disabled||(b=t.dataRef.current)!=null&&b.optionsRef.current&&!((n=t.dataRef.current)!=null&&n.optionsPropsRef.current.static)&&t.comboboxState===1)return t;let e=re(t);if(e.activeOptionIndex===null){let o=e.options.findIndex(u=>!u.dataRef.current.disabled);o!==-1&&(e.activeOptionIndex=o)}let r=(0,calculate_active_index/* calculateActiveIndex */.d)(l,{resolveItems:()=>e.options,resolveActiveIndex:()=>e.activeOptionIndex,resolveId:o=>o.id,resolveDisabled:o=>o.dataRef.current.disabled});return{...t,...e,activeOptionIndex:r,activationTrigger:(d=l.trigger)!=null?d:1}},[3]:(t,l)=>{var b,n;let e={id:l.id,dataRef:l.dataRef},r=re(t,d=>[...d,e]);t.activeOptionIndex===null&&(b=t.dataRef.current)!=null&&b.isSelected(l.dataRef.current.value)&&(r.activeOptionIndex=r.options.indexOf(e));let i={...t,...r,activationTrigger:1};return(n=t.dataRef.current)!=null&&n.__demoMode&&t.dataRef.current.value===void 0&&(i.activeOptionIndex=0),i},[4]:(t,l)=>{let e=re(t,r=>{let i=r.findIndex(b=>b.id===l.id);return i!==-1&&r.splice(i,1),r});return{...t,...e,activationTrigger:1}},[5]:(t,l)=>({...t,labelId:l.id})},ae=(0,react_.createContext)(null);ae.displayName="ComboboxActionsContext";function $(t){let l=(0,react_.useContext)(ae);if(l===null){let e=new Error(`<${t} /> is missing a parent <Combobox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(e,$),e}return l}let le=(0,react_.createContext)(null);le.displayName="ComboboxDataContext";function H(t){let l=(0,react_.useContext)(le);if(l===null){let e=new Error(`<${t} /> is missing a parent <Combobox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(e,H),e}return l}function Ge(t,l){return (0,match/* match */.E)(l.type,He,t,l)}let Xe=react_.Fragment;function je(t,l){let{value:e,defaultValue:r,onChange:i,form:b,name:n,by:d=(p,T)=>p===T,disabled:o=!1,__demoMode:u=!1,nullable:P=!1,multiple:f=!1,...E}=t,[c=f?[]:void 0,g]=(0,use_controllable/* useControllable */.q)(e,i,r),[m,x]=(0,react_.useReducer)(Ge,{dataRef:(0,react_.createRef)(),comboboxState:u?0:1,options:[],activeOptionIndex:null,activationTrigger:1,labelId:null}),L=(0,react_.useRef)(!1),F=(0,react_.useRef)({static:!1,hold:!1}),h=(0,react_.useRef)(null),B=(0,react_.useRef)(null),k=(0,react_.useRef)(null),G=(0,react_.useRef)(null),V=(0,use_event/* useEvent */.z)(typeof d=="string"?(p,T)=>{let R=d;return(p==null?void 0:p[R])===(T==null?void 0:T[R])}:d),M=(0,react_.useCallback)(p=>(0,match/* match */.E)(s.mode,{[1]:()=>c.some(T=>V(T,p)),[0]:()=>V(c,p)}),[c]),s=(0,react_.useMemo)(()=>({...m,optionsPropsRef:F,labelRef:h,inputRef:B,buttonRef:k,optionsRef:G,value:c,defaultValue:r,disabled:o,mode:f?1:0,get activeOptionIndex(){if(L.current&&m.activeOptionIndex===null&&m.options.length>0){let p=m.options.findIndex(T=>!T.dataRef.current.disabled);if(p!==-1)return p}return m.activeOptionIndex},compare:V,isSelected:M,nullable:P,__demoMode:u}),[c,r,o,f,P,u,m]),O=(0,react_.useRef)(s.activeOptionIndex!==null?s.options[s.activeOptionIndex]:null);(0,react_.useEffect)(()=>{let p=s.activeOptionIndex!==null?s.options[s.activeOptionIndex]:null;O.current!==p&&(O.current=p)}),(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{m.dataRef.current=s},[s]),(0,use_outside_click/* useOutsideClick */.O)([s.buttonRef,s.inputRef,s.optionsRef],()=>oe.closeCombobox(),s.comboboxState===0);let a=(0,react_.useMemo)(()=>({open:s.comboboxState===0,disabled:o,activeIndex:s.activeOptionIndex,activeOption:s.activeOptionIndex===null?null:s.options[s.activeOptionIndex].dataRef.current.value,value:c}),[s,o,c]),I=(0,use_event/* useEvent */.z)(p=>{let T=s.options.find(R=>R.id===p);T&&j(T.dataRef.current.value)}),S=(0,use_event/* useEvent */.z)(()=>{if(s.activeOptionIndex!==null){let{dataRef:p,id:T}=s.options[s.activeOptionIndex];j(p.current.value),oe.goToOption(calculate_active_index/* Focus.Specific */.T.Specific,T)}}),X=(0,use_event/* useEvent */.z)(()=>{x({type:0}),L.current=!0}),q=(0,use_event/* useEvent */.z)(()=>{x({type:1}),L.current=!1}),Q=(0,use_event/* useEvent */.z)((p,T,R)=>(L.current=!1,p===calculate_active_index/* Focus.Specific */.T.Specific?x({type:2,focus:calculate_active_index/* Focus.Specific */.T.Specific,id:T,trigger:R}):x({type:2,focus:p,trigger:R}))),Y=(0,use_event/* useEvent */.z)((p,T)=>(x({type:3,id:p,dataRef:T}),()=>{var R;((R=O.current)==null?void 0:R.id)===p&&(L.current=!0),x({type:4,id:p})})),ce=(0,use_event/* useEvent */.z)(p=>(x({type:5,id:p}),()=>x({type:5,id:null}))),j=(0,use_event/* useEvent */.z)(p=>(0,match/* match */.E)(s.mode,{[0](){return g==null?void 0:g(p)},[1](){let T=s.value.slice(),R=T.findIndex(J=>V(J,p));return R===-1?T.push(p):T.splice(R,1),g==null?void 0:g(T)}})),oe=(0,react_.useMemo)(()=>({onChange:j,registerOption:Y,registerLabel:ce,goToOption:Q,closeCombobox:q,openCombobox:X,selectActiveOption:S,selectOption:I}),[]),Te=l===null?{}:{ref:l},Z=(0,react_.useRef)(null),me=(0,use_disposables/* useDisposables */.G)();return (0,react_.useEffect)(()=>{Z.current&&r!==void 0&&me.addEventListener(Z.current,"reset",()=>{j(r)})},[Z,j]),react_.createElement(ae.Provider,{value:oe},react_.createElement(le.Provider,{value:s},react_.createElement(open_closed/* OpenClosedProvider */.up,{value:(0,match/* match */.E)(s.comboboxState,{[0]:open_closed/* State.Open */.ZM.Open,[1]:open_closed/* State.Closed */.ZM.Closed})},n!=null&&c!=null&&(0,utils_form/* objectToFormEntries */.t)({[n]:c}).map(([p,T],R)=>react_.createElement(internal_hidden/* Hidden */._,{features:internal_hidden/* Features.Hidden */.A.Hidden,ref:R===0?J=>{var ie;Z.current=(ie=J==null?void 0:J.closest("form"))!=null?ie:null}:void 0,...(0,render/* compact */.oA)({key:p,as:"input",type:"hidden",hidden:!0,readOnly:!0,form:b,name:p,value:T})})),(0,render/* render */.sY)({ourProps:Te,theirProps:E,slot:a,defaultTag:Xe,name:"Combobox"}))))}let Je="input";function Ke(t,l){var V,M,s,O;let e=(0,use_id/* useId */.M)(),{id:r=`headlessui-combobox-input-${e}`,onChange:i,displayValue:b,type:n="text",...d}=t,o=H("Combobox.Input"),u=$("Combobox.Input"),P=(0,use_sync_refs/* useSyncRefs */.T)(o.inputRef,l),f=(0,react_.useRef)(!1),E=(0,use_disposables/* useDisposables */.G)(),c=function(){var a;return typeof b=="function"&&o.value!==void 0?(a=b(o.value))!=null?a:"":typeof o.value=="string"?o.value:""}();(0,use_watch/* useWatch */.q)(([a,I],[S,X])=>{f.current||o.inputRef.current&&(X===0&&I===1||a!==S)&&(o.inputRef.current.value=a)},[c,o.comboboxState]),(0,use_watch/* useWatch */.q)(([a],[I])=>{if(a===0&&I===1){let S=o.inputRef.current;if(!S)return;let X=S.value,{selectionStart:q,selectionEnd:Q,selectionDirection:Y}=S;S.value="",S.value=X,Y!==null?S.setSelectionRange(q,Q,Y):S.setSelectionRange(q,Q)}},[o.comboboxState]);let g=(0,react_.useRef)(!1),m=(0,use_event/* useEvent */.z)(()=>{g.current=!0}),x=(0,use_event/* useEvent */.z)(()=>{setTimeout(()=>{g.current=!1})}),L=(0,use_event/* useEvent */.z)(a=>{switch(f.current=!0,a.key){case keyboard/* Keys.Backspace */.R.Backspace:case keyboard/* Keys.Delete */.R.Delete:if(o.mode!==0||!o.nullable)return;let I=a.currentTarget;E.requestAnimationFrame(()=>{I.value===""&&(u.onChange(null),o.optionsRef.current&&(o.optionsRef.current.scrollTop=0),u.goToOption(calculate_active_index/* Focus.Nothing */.T.Nothing))});break;case keyboard/* Keys.Enter */.R.Enter:if(f.current=!1,o.comboboxState!==0||g.current)return;if(a.preventDefault(),a.stopPropagation(),o.activeOptionIndex===null){u.closeCombobox();return}u.selectActiveOption(),o.mode===0&&u.closeCombobox();break;case keyboard/* Keys.ArrowDown */.R.ArrowDown:return f.current=!1,a.preventDefault(),a.stopPropagation(),(0,match/* match */.E)(o.comboboxState,{[0]:()=>{u.goToOption(calculate_active_index/* Focus.Next */.T.Next)},[1]:()=>{u.openCombobox()}});case keyboard/* Keys.ArrowUp */.R.ArrowUp:return f.current=!1,a.preventDefault(),a.stopPropagation(),(0,match/* match */.E)(o.comboboxState,{[0]:()=>{u.goToOption(calculate_active_index/* Focus.Previous */.T.Previous)},[1]:()=>{u.openCombobox(),E.nextFrame(()=>{o.value||u.goToOption(calculate_active_index/* Focus.Last */.T.Last)})}});case keyboard/* Keys.Home */.R.Home:if(a.shiftKey)break;return f.current=!1,a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index/* Focus.First */.T.First);case keyboard/* Keys.PageUp */.R.PageUp:return f.current=!1,a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index/* Focus.First */.T.First);case keyboard/* Keys.End */.R.End:if(a.shiftKey)break;return f.current=!1,a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index/* Focus.Last */.T.Last);case keyboard/* Keys.PageDown */.R.PageDown:return f.current=!1,a.preventDefault(),a.stopPropagation(),u.goToOption(calculate_active_index/* Focus.Last */.T.Last);case keyboard/* Keys.Escape */.R.Escape:return f.current=!1,o.comboboxState!==0?void 0:(a.preventDefault(),o.optionsRef.current&&!o.optionsPropsRef.current.static&&a.stopPropagation(),u.closeCombobox());case keyboard/* Keys.Tab */.R.Tab:if(f.current=!1,o.comboboxState!==0)return;o.mode===0&&u.selectActiveOption(),u.closeCombobox();break}}),F=(0,use_event/* useEvent */.z)(a=>{u.openCombobox(),i==null||i(a)}),h=(0,use_event/* useEvent */.z)(()=>{f.current=!1}),B=(0,use_computed/* useComputed */.v)(()=>{if(o.labelId)return[o.labelId].join(" ")},[o.labelId]),k=(0,react_.useMemo)(()=>({open:o.comboboxState===0,disabled:o.disabled}),[o]),G={ref:P,id:r,role:"combobox",type:n,"aria-controls":(V=o.optionsRef.current)==null?void 0:V.id,"aria-expanded":o.disabled?void 0:o.comboboxState===0,"aria-activedescendant":o.activeOptionIndex===null||(M=o.options[o.activeOptionIndex])==null?void 0:M.id,"aria-labelledby":B,"aria-autocomplete":"list",defaultValue:(O=(s=t.defaultValue)!=null?s:o.defaultValue!==void 0?b==null?void 0:b(o.defaultValue):null)!=null?O:o.defaultValue,disabled:o.disabled,onCompositionStart:m,onCompositionEnd:x,onKeyDown:L,onChange:F,onBlur:h};return (0,render/* render */.sY)({ourProps:G,theirProps:d,slot:k,defaultTag:Je,name:"Combobox.Input"})}let We="button";function $e(t,l){var g;let e=H("Combobox.Button"),r=$("Combobox.Button"),i=(0,use_sync_refs/* useSyncRefs */.T)(e.buttonRef,l),b=(0,use_id/* useId */.M)(),{id:n=`headlessui-combobox-button-${b}`,...d}=t,o=(0,use_disposables/* useDisposables */.G)(),u=(0,use_event/* useEvent */.z)(m=>{switch(m.key){case keyboard/* Keys.ArrowDown */.R.ArrowDown:return m.preventDefault(),m.stopPropagation(),e.comboboxState===1&&r.openCombobox(),o.nextFrame(()=>{var x;return(x=e.inputRef.current)==null?void 0:x.focus({preventScroll:!0})});case keyboard/* Keys.ArrowUp */.R.ArrowUp:return m.preventDefault(),m.stopPropagation(),e.comboboxState===1&&(r.openCombobox(),o.nextFrame(()=>{e.value||r.goToOption(calculate_active_index/* Focus.Last */.T.Last)})),o.nextFrame(()=>{var x;return(x=e.inputRef.current)==null?void 0:x.focus({preventScroll:!0})});case keyboard/* Keys.Escape */.R.Escape:return e.comboboxState!==0?void 0:(m.preventDefault(),e.optionsRef.current&&!e.optionsPropsRef.current.static&&m.stopPropagation(),r.closeCombobox(),o.nextFrame(()=>{var x;return(x=e.inputRef.current)==null?void 0:x.focus({preventScroll:!0})}));default:return}}),P=(0,use_event/* useEvent */.z)(m=>{if((0,bugs/* isDisabledReactIssue7711 */.P)(m.currentTarget))return m.preventDefault();e.comboboxState===0?r.closeCombobox():(m.preventDefault(),r.openCombobox()),o.nextFrame(()=>{var x;return(x=e.inputRef.current)==null?void 0:x.focus({preventScroll:!0})})}),f=(0,use_computed/* useComputed */.v)(()=>{if(e.labelId)return[e.labelId,n].join(" ")},[e.labelId,n]),E=(0,react_.useMemo)(()=>({open:e.comboboxState===0,disabled:e.disabled,value:e.value}),[e]),c={ref:i,id:n,type:(0,use_resolve_button_type/* useResolveButtonType */.f)(t,e.buttonRef),tabIndex:-1,"aria-haspopup":"listbox","aria-controls":(g=e.optionsRef.current)==null?void 0:g.id,"aria-expanded":e.disabled?void 0:e.comboboxState===0,"aria-labelledby":f,disabled:e.disabled,onClick:P,onKeyDown:u};return (0,render/* render */.sY)({ourProps:c,theirProps:d,slot:E,defaultTag:We,name:"Combobox.Button"})}let qe="label";function Qe(t,l){let e=(0,use_id/* useId */.M)(),{id:r=`headlessui-combobox-label-${e}`,...i}=t,b=H("Combobox.Label"),n=$("Combobox.Label"),d=(0,use_sync_refs/* useSyncRefs */.T)(b.labelRef,l);(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>n.registerLabel(r),[r]);let o=(0,use_event/* useEvent */.z)(()=>{var f;return(f=b.inputRef.current)==null?void 0:f.focus({preventScroll:!0})}),u=(0,react_.useMemo)(()=>({open:b.comboboxState===0,disabled:b.disabled}),[b]);return (0,render/* render */.sY)({ourProps:{ref:d,id:r,onClick:o},theirProps:i,slot:u,defaultTag:qe,name:"Combobox.Label"})}let Ye="ul",Ze=render/* Features.RenderStrategy */.AN.RenderStrategy|render/* Features.Static */.AN.Static;function ze(t,l){let e=(0,use_id/* useId */.M)(),{id:r=`headlessui-combobox-options-${e}`,hold:i=!1,...b}=t,n=H("Combobox.Options"),d=(0,use_sync_refs/* useSyncRefs */.T)(n.optionsRef,l),o=(0,open_closed/* useOpenClosed */.oJ)(),u=(()=>o!==null?(o&open_closed/* State.Open */.ZM.Open)===open_closed/* State.Open */.ZM.Open:n.comboboxState===0)();(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{var c;n.optionsPropsRef.current.static=(c=t.static)!=null?c:!1},[n.optionsPropsRef,t.static]),(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{n.optionsPropsRef.current.hold=i},[n.optionsPropsRef,i]),F({container:n.optionsRef.current,enabled:n.comboboxState===0,accept(c){return c.getAttribute("role")==="option"?NodeFilter.FILTER_REJECT:c.hasAttribute("role")?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_ACCEPT},walk(c){c.setAttribute("role","none")}});let P=(0,use_computed/* useComputed */.v)(()=>{var c,g;return(g=n.labelId)!=null?g:(c=n.buttonRef.current)==null?void 0:c.id},[n.labelId,n.buttonRef.current]),f=(0,react_.useMemo)(()=>({open:n.comboboxState===0}),[n]),E={"aria-labelledby":P,role:"listbox","aria-multiselectable":n.mode===1?!0:void 0,id:r,ref:d};return (0,render/* render */.sY)({ourProps:E,theirProps:b,slot:f,defaultTag:Ye,features:Ze,visible:u,name:"Combobox.Options"})}let eo="li";function oo(t,l){var M,s;let e=(0,use_id/* useId */.M)(),{id:r=`headlessui-combobox-option-${e}`,disabled:i=!1,value:b,...n}=t,d=H("Combobox.Option"),o=$("Combobox.Option"),u=d.activeOptionIndex!==null?d.options[d.activeOptionIndex].id===r:!1,P=d.isSelected(b),f=(0,react_.useRef)(null),E=(0,use_latest_value/* useLatestValue */.E)({disabled:i,value:b,domRef:f,textValue:(s=(M=f.current)==null?void 0:M.textContent)==null?void 0:s.toLowerCase()}),c=(0,use_sync_refs/* useSyncRefs */.T)(l,f),g=(0,use_event/* useEvent */.z)(()=>o.selectOption(r));(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>o.registerOption(r,E),[E,r]);let m=(0,react_.useRef)(!d.__demoMode);(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{if(!d.__demoMode)return;let O=(0,disposables/* disposables */.k)();return O.requestAnimationFrame(()=>{m.current=!0}),O.dispose},[]),(0,use_iso_morphic_effect/* useIsoMorphicEffect */.e)(()=>{if(d.comboboxState!==0||!u||!m.current||d.activationTrigger===0)return;let O=(0,disposables/* disposables */.k)();return O.requestAnimationFrame(()=>{var a,I;(I=(a=f.current)==null?void 0:a.scrollIntoView)==null||I.call(a,{block:"nearest"})}),O.dispose},[f,u,d.comboboxState,d.activationTrigger,d.activeOptionIndex]);let x=(0,use_event/* useEvent */.z)(O=>{if(i)return O.preventDefault();g(),d.mode===0&&o.closeCombobox(),(0,platform/* isMobile */.tq)()||requestAnimationFrame(()=>{var a;return(a=d.inputRef.current)==null?void 0:a.focus()})}),L=(0,use_event/* useEvent */.z)(()=>{if(i)return o.goToOption(calculate_active_index/* Focus.Nothing */.T.Nothing);o.goToOption(calculate_active_index/* Focus.Specific */.T.Specific,r)}),F=(0,use_tracked_pointer/* useTrackedPointer */.g)(),h=(0,use_event/* useEvent */.z)(O=>F.update(O)),B=(0,use_event/* useEvent */.z)(O=>{F.wasMoved(O)&&(i||u||o.goToOption(calculate_active_index/* Focus.Specific */.T.Specific,r,0))}),k=(0,use_event/* useEvent */.z)(O=>{F.wasMoved(O)&&(i||u&&(d.optionsPropsRef.current.hold||o.goToOption(calculate_active_index/* Focus.Nothing */.T.Nothing)))}),G=(0,react_.useMemo)(()=>({active:u,selected:P,disabled:i}),[u,P,i]);return (0,render/* render */.sY)({ourProps:{id:r,ref:c,role:"option",tabIndex:i===!0?void 0:-1,"aria-disabled":i===!0?!0:void 0,"aria-selected":P,disabled:void 0,onClick:x,onFocus:L,onPointerEnter:h,onMouseEnter:h,onPointerMove:B,onMouseMove:B,onPointerLeave:k,onMouseLeave:k},theirProps:n,slot:G,defaultTag:eo,name:"Combobox.Option"})}let to=(0,render/* forwardRefWithAs */.yV)(je),no=(0,render/* forwardRefWithAs */.yV)($e),ro=(0,render/* forwardRefWithAs */.yV)(Ke),ao=(0,render/* forwardRefWithAs */.yV)(Qe),lo=(0,render/* forwardRefWithAs */.yV)(ze),io=(0,render/* forwardRefWithAs */.yV)(oo),Wo=Object.assign(to,{Input:ro,Button:no,Label:ao,Options:lo,Option:io});
...
/* harmony import */ var _hooks_use_disposables_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8060);
/* harmony import */ var _hooks_use_id_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(6304);
/* harmony import */ var _hooks_use_iso_morphic_effect_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3652);
/* harmony import */ var _hooks_use_computed_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(6570);
/* harmony import */ var _hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1464);
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1147);
/* harmony import */ var _utils_match_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8118);
/* harmony import */ var _utils_disposables_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(2698);
/* harmony import */ var _keyboard_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1550);
/* harmony import */ var _utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3120);
/* harmony import */ var _utils_bugs_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(5410);
/* harmony import */ var _utils_focus_management_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3110);
/* harmony import */ var _internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7844);
/* harmony import */ var _hooks_use_resolve_button_type_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(986);
/* harmony import */ var _hooks_use_outside_click_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(317);
/* harmony import */ var _internal_hidden_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9042);
/* harmony import */ var _utils_form_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(5381);
/* harmony import */ var _utils_owner_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(1506);
/* harmony import */ var _hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2264);
/* harmony import */ var _hooks_use_controllable_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3013);
/* harmony import */ var _hooks_use_latest_value_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(4612);
/* harmony import */ var _hooks_use_tracked_pointer_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(4386);
var Ue=(o=>(o[o.Open=0]="Open",o[o.Closed=1]="Closed",o))(Ue||{}),Be=(o=>(o[o.Single=0]="Single",o[o.Multi=1]="Multi",o))(Be||{}),He=(o=>(o[o.Pointer=0]="Pointer",o[o.Other=1]="Other",o))(He||{}),Ge=(i=>(i[i.OpenListbox=0]="OpenListbox",i[i.CloseListbox=1]="CloseListbox",i[i.GoToOption=2]="GoToOption",i[i.Search=3]="Search",i[i.ClearSearch=4]="ClearSearch",i[i.RegisterOption=5]="RegisterOption",i[i.UnregisterOption=6]="UnregisterOption",i[i.RegisterLabel=7]="RegisterLabel",i))(Ge||{});function X(e,a=o=>o){let o=e.activeOptionIndex!==null?e.options[e.activeOptionIndex]:null,r=(0,_utils_focus_management_js__WEBPACK_IMPORTED_MODULE_1__/* .sortByDomNode */ .z2)(a(e.options.slice()),t=>t.dataRef.current.domRef.current),l=o?r.indexOf(o):null;return l===-1&&(l=null),{options:r,activeOptionIndex:l}}let Ne={[1](e){return e.dataRef.current.disabled||e.listboxState===1?e:{...e,activeOptionIndex:null,listboxState:1}},[0](e){if(e.dataRef.current.disabled||e.listboxState===0)return e;let a=e.activeOptionIndex,{isSelected:o}=e.dataRef.current,r=e.options.findIndex(l=>o(l.dataRef.current.value));return r!==-1&&(a=r),{...e,listboxState:0,activeOptionIndex:a}},[2](e,a){var l;if(e.dataRef.current.disabled||e.listboxState===1)return e;let o=X(e),r=(0,_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .calculateActiveIndex */ .d)(a,{resolveItems:()=>o.options,resolveActiveIndex:()=>o.activeOptionIndex,resolveId:t=>t.id,resolveDisabled:t=>t.dataRef.current.disabled});return{...e,...o,searchQuery:"",activeOptionIndex:r,activationTrigger:(l=a.trigger)!=null?l:1}},[3]:(e,a)=>{if(e.dataRef.current.disabled||e.listboxState===1)return e;let r=e.searchQuery!==""?0:1,l=e.searchQuery+a.value.toLowerCase(),p=(e.activeOptionIndex!==null?e.options.slice(e.activeOptionIndex+r).concat(e.options.slice(0,e.activeOptionIndex+r)):e.options).find(i=>{var b;return!i.dataRef.current.disabled&&((b=i.dataRef.current.textValue)==null?void 0:b.startsWith(l))}),u=p?e.options.indexOf(p):-1;return u===-1||u===e.activeOptionIndex?{...e,searchQuery:l}:{...e,searchQuery:l,activeOptionIndex:u,activationTrigger:1}},[4](e){return e.dataRef.current.disabled||e.listboxState===1||e.searchQuery===""?e:{...e,searchQuery:""}},[5]:(e,a)=>{let o={id:a.id,dataRef:a.dataRef},r=X(e,l=>[...l,o]);return e.activeOptionIndex===null&&e.dataRef.current.isSelected(a.dataRef.current.value)&&(r.activeOptionIndex=r.options.indexOf(o)),{...e,...r}},[6]:(e,a)=>{let o=X(e,r=>{let l=r.findIndex(t=>t.id===a.id);return l!==-1&&r.splice(l,1),r});return{...e,...o,activationTrigger:1}},[7]:(e,a)=>({...e,labelId:a.id})},$=(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);$.displayName="ListboxActionsContext";function U(e){let a=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)($);if(a===null){let o=new Error(`<${e} /> is missing a parent <Listbox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(o,U),o}return a}let z=(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);z.displayName="ListboxDataContext";function B(e){let a=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(z);if(a===null){let o=new Error(`<${e} /> is missing a parent <Listbox /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(o,B),o}return a}function je(e,a){return (0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(a.type,Ne,e,a)}let Ve=react__WEBPACK_IMPORTED_MODULE_0__.Fragment;function Ke(e,a){let{value:o,defaultValue:r,form:l,name:t,onChange:p,by:u=(s,d)=>s===d,disabled:i=!1,horizontal:b=!1,multiple:R=!1,...m}=e;const P=b?"horizontal":"vertical";let E=(0,_hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__/* .useSyncRefs */ .T)(a),[L=R?[]:void 0,v]=(0,_hooks_use_controllable_js__WEBPACK_IMPORTED_MODULE_5__/* .useControllable */ .q)(o,p,r),[c,n]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(je,{dataRef:(0,react__WEBPACK_IMPORTED_MODULE_0__.createRef)(),listboxState:1,options:[],searchQuery:"",labelId:null,activeOptionIndex:null,activationTrigger:1}),x=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({static:!1,hold:!1}),h=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),Q=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),J=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),y=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(typeof u=="string"?(s,d)=>{let O=u;return(s==null?void 0:s[O])===(d==null?void 0:d[O])}:u),S=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(s=>(0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(T.mode,{[1]:()=>L.some(d=>y(d,s)),[0]:()=>y(L,s)}),[L]),T=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({...c,value:L,disabled:i,mode:R?1:0,orientation:P,compare:y,isSelected:S,optionsPropsRef:x,labelRef:h,buttonRef:Q,optionsRef:J}),[L,i,R,c]);(0,_hooks_use_iso_morphic_effect_js__WEBPACK_IMPORTED_MODULE_7__/* .useIsoMorphicEffect */ .e)(()=>{c.dataRef.current=T},[T]),(0,_hooks_use_outside_click_js__WEBPACK_IMPORTED_MODULE_8__/* .useOutsideClick */ .O)([T.buttonRef,T.optionsRef],(s,d)=>{var O;n({type:1}),(0,_utils_focus_management_js__WEBPACK_IMPORTED_MODULE_1__/* .isFocusableElement */ .sP)(d,_utils_focus_management_js__WEBPACK_IMPORTED_MODULE_1__/* .FocusableMode.Loose */ .tJ.Loose)||(s.preventDefault(),(O=T.buttonRef.current)==null||O.focus())},T.listboxState===0);let ne=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({open:T.listboxState===0,disabled:i,value:L}),[T,i,L]),ie=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(s=>{let d=T.options.find(O=>O.id===s);d&&F(d.dataRef.current.value)}),re=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>{if(T.activeOptionIndex!==null){let{dataRef:s,id:d}=T.options[T.activeOptionIndex];F(s.current.value),n({type:2,focus:_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Specific */ .T.Specific,id:d})}}),ae=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>n({type:0})),le=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>n({type:1})),se=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)((s,d,O)=>s===_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Specific */ .T.Specific?n({type:2,focus:_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Specific */ .T.Specific,id:d,trigger:O}):n({type:2,focus:s,trigger:O})),pe=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)((s,d)=>(n({type:5,id:s,dataRef:d}),()=>n({type:6,id:s}))),ue=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(s=>(n({type:7,id:s}),()=>n({type:7,id:null}))),F=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(s=>(0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(T.mode,{[0](){return v==null?void 0:v(s)},[1](){let d=T.value.slice(),O=d.findIndex(M=>y(M,s));return O===-1?d.push(s):d.splice(O,1),v==null?void 0:v(d)}})),de=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(s=>n({type:3,value:s})),ce=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>n({type:4})),fe=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({onChange:F,registerOption:pe,registerLabel:ue,goToOption:se,closeListbox:le,openListbox:ae,selectActiveOption:re,selectOption:ie,search:de,clearSearch:ce}),[]),Te={ref:E},H=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),be=(0,_hooks_use_disposables_js__WEBPACK_IMPORTED_MODULE_9__/* .useDisposables */ .G)();return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{H.current&&r!==void 0&&be.addEventListener(H.current,"reset",()=>{F(r)})},[H,F]),react__WEBPACK_IMPORTED_MODULE_0__.createElement($.Provider,{value:fe},react__WEBPACK_IMPORTED_MODULE_0__.createElement(z.Provider,{value:T},react__WEBPACK_IMPORTED_MODULE_0__.createElement(_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .OpenClosedProvider */ .up,{value:(0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(T.listboxState,{[0]:_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .State.Open */ .ZM.Open,[1]:_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .State.Closed */ .ZM.Closed})},t!=null&&L!=null&&(0,_utils_form_js__WEBPACK_IMPORTED_MODULE_11__/* .objectToFormEntries */ .t)({[t]:L}).map(([s,d],O)=>react__WEBPACK_IMPORTED_MODULE_0__.createElement(_internal_hidden_js__WEBPACK_IMPORTED_MODULE_12__/* .Hidden */ ._,{features:_internal_hidden_js__WEBPACK_IMPORTED_MODULE_12__/* .Features.Hidden */ .A.Hidden,ref:O===0?M=>{var q;H.current=(q=M==null?void 0:M.closest("form"))!=null?q:null}:void 0,...(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .compact */ .oA)({key:s,as:"input",type:"hidden",hidden:!0,readOnly:!0,form:l,name:s,value:d})})),(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .render */ .sY)({ourProps:Te,theirProps:m,slot:ne,defaultTag:Ve,name:"Listbox"}))))}let Qe="button";function We(e,a){var v;let o=(0,_hooks_use_id_js__WEBPACK_IMPORTED_MODULE_14__/* .useId */ .M)(),{id:r=`headlessui-listbox-button-${o}`,...l}=e,t=B("Listbox.Button"),p=U("Listbox.Button"),u=(0,_hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__/* .useSyncRefs */ .T)(t.buttonRef,a),i=(0,_hooks_use_disposables_js__WEBPACK_IMPORTED_MODULE_9__/* .useDisposables */ .G)(),b=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(c=>{switch(c.key){case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Space */ .R.Space:case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Enter */ .R.Enter:case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowDown */ .R.ArrowDown:c.preventDefault(),p.openListbox(),i.nextFrame(()=>{t.value||p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.First */ .T.First)});break;case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowUp */ .R.ArrowUp:c.preventDefault(),p.openListbox(),i.nextFrame(()=>{t.value||p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Last */ .T.Last)});break}}),R=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(c=>{switch(c.key){case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Space */ .R.Space:c.preventDefault();break}}),m=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(c=>{if((0,_utils_bugs_js__WEBPACK_IMPORTED_MODULE_16__/* .isDisabledReactIssue7711 */ .P)(c.currentTarget))return c.preventDefault();t.listboxState===0?(p.closeListbox(),i.nextFrame(()=>{var n;return(n=t.buttonRef.current)==null?void 0:n.focus({preventScroll:!0})})):(c.preventDefault(),p.openListbox())}),P=(0,_hooks_use_computed_js__WEBPACK_IMPORTED_MODULE_17__/* .useComputed */ .v)(()=>{if(t.labelId)return[t.labelId,r].join(" ")},[t.labelId,r]),E=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({open:t.listboxState===0,disabled:t.disabled,value:t.value}),[t]),L={ref:u,id:r,type:(0,_hooks_use_resolve_button_type_js__WEBPACK_IMPORTED_MODULE_18__/* .useResolveButtonType */ .f)(e,t.buttonRef),"aria-haspopup":"listbox","aria-controls":(v=t.optionsRef.current)==null?void 0:v.id,"aria-expanded":t.disabled?void 0:t.listboxState===0,"aria-labelledby":P,disabled:t.disabled,onKeyDown:b,onKeyUp:R,onClick:m};return (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .render */ .sY)({ourProps:L,theirProps:l,slot:E,defaultTag:Qe,name:"Listbox.Button"})}let Xe="label";function $e(e,a){let o=(0,_hooks_use_id_js__WEBPACK_IMPORTED_MODULE_14__/* .useId */ .M)(),{id:r=`headlessui-listbox-label-${o}`,...l}=e,t=B("Listbox.Label"),p=U("Listbox.Label"),u=(0,_hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__/* .useSyncRefs */ .T)(t.labelRef,a);(0,_hooks_use_iso_morphic_effect_js__WEBPACK_IMPORTED_MODULE_7__/* .useIsoMorphicEffect */ .e)(()=>p.registerLabel(r),[r]);let i=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>{var m;return(m=t.buttonRef.current)==null?void 0:m.focus({preventScroll:!0})}),b=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({open:t.listboxState===0,disabled:t.disabled}),[t]);return (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .render */ .sY)({ourProps:{ref:u,id:r,onClick:i},theirProps:l,slot:b,defaultTag:Xe,name:"Listbox.Label"})}let ze="ul",Je=_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .Features.RenderStrategy */ .AN.RenderStrategy|_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .Features.Static */ .AN.Static;function qe(e,a){var c;let o=(0,_hooks_use_id_js__WEBPACK_IMPORTED_MODULE_14__/* .useId */ .M)(),{id:r=`headlessui-listbox-options-${o}`,...l}=e,t=B("Listbox.Options"),p=U("Listbox.Options"),u=(0,_hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__/* .useSyncRefs */ .T)(t.optionsRef,a),i=(0,_hooks_use_disposables_js__WEBPACK_IMPORTED_MODULE_9__/* .useDisposables */ .G)(),b=(0,_hooks_use_disposables_js__WEBPACK_IMPORTED_MODULE_9__/* .useDisposables */ .G)(),R=(0,_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .useOpenClosed */ .oJ)(),m=(()=>R!==null?(R&_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .State.Open */ .ZM.Open)===_internal_open_closed_js__WEBPACK_IMPORTED_MODULE_10__/* .State.Open */ .ZM.Open:t.listboxState===0)();(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{var x;let n=t.optionsRef.current;n&&t.listboxState===0&&n!==((x=(0,_utils_owner_js__WEBPACK_IMPORTED_MODULE_19__/* .getOwnerDocument */ .r)(n))==null?void 0:x.activeElement)&&n.focus({preventScroll:!0})},[t.listboxState,t.optionsRef]);let P=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(n=>{switch(b.dispose(),n.key){case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Space */ .R.Space:if(t.searchQuery!=="")return n.preventDefault(),n.stopPropagation(),p.search(n.key);case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Enter */ .R.Enter:if(n.preventDefault(),n.stopPropagation(),t.activeOptionIndex!==null){let{dataRef:x}=t.options[t.activeOptionIndex];p.onChange(x.current.value)}t.mode===0&&(p.closeListbox(),(0,_utils_disposables_js__WEBPACK_IMPORTED_MODULE_20__/* .disposables */ .k)().nextFrame(()=>{var x;return(x=t.buttonRef.current)==null?void 0:x.focus({preventScroll:!0})}));break;case (0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(t.orientation,{vertical:_keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowDown */ .R.ArrowDown,horizontal:_keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowRight */ .R.ArrowRight}):return n.preventDefault(),n.stopPropagation(),p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Next */ .T.Next);case (0,_utils_match_js__WEBPACK_IMPORTED_MODULE_3__/* .match */ .E)(t.orientation,{vertical:_keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowUp */ .R.ArrowUp,horizontal:_keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.ArrowLeft */ .R.ArrowLeft}):return n.preventDefault(),n.stopPropagation(),p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Previous */ .T.Previous);case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Home */ .R.Home:case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.PageUp */ .R.PageUp:return n.preventDefault(),n.stopPropagation(),p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.First */ .T.First);case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.End */ .R.End:case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.PageDown */ .R.PageDown:return n.preventDefault(),n.stopPropagation(),p.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Last */ .T.Last);case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Escape */ .R.Escape:return n.preventDefault(),n.stopPropagation(),p.closeListbox(),i.nextFrame(()=>{var x;return(x=t.buttonRef.current)==null?void 0:x.focus({preventScroll:!0})});case _keyboard_js__WEBPACK_IMPORTED_MODULE_15__/* .Keys.Tab */ .R.Tab:n.preventDefault(),n.stopPropagation();break;default:n.key.length===1&&(p.search(n.key),b.setTimeout(()=>p.clearSearch(),350));break}}),E=(0,_hooks_use_computed_js__WEBPACK_IMPORTED_MODULE_17__/* .useComputed */ .v)(()=>{var n,x,h;return(h=(n=t.labelRef.current)==null?void 0:n.id)!=null?h:(x=t.buttonRef.current)==null?void 0:x.id},[t.labelRef.current,t.buttonRef.current]),L=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({open:t.listboxState===0}),[t]),v={"aria-activedescendant":t.activeOptionIndex===null||(c=t.options[t.activeOptionIndex])==null?void 0:c.id,"aria-multiselectable":t.mode===1?!0:void 0,"aria-labelledby":E,"aria-orientation":t.orientation,id:r,onKeyDown:P,role:"listbox",tabIndex:0,ref:u};return (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .render */ .sY)({ourProps:v,theirProps:l,slot:L,defaultTag:ze,features:Je,visible:m,name:"Listbox.Options"})}let Ye="li";function Ze(e,a){let o=(0,_hooks_use_id_js__WEBPACK_IMPORTED_MODULE_14__/* .useId */ .M)(),{id:r=`headlessui-listbox-option-${o}`,disabled:l=!1,value:t,...p}=e,u=B("Listbox.Option"),i=U("Listbox.Option"),b=u.activeOptionIndex!==null?u.options[u.activeOptionIndex].id===r:!1,R=u.isSelected(t),m=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null),P=(0,_hooks_use_latest_value_js__WEBPACK_IMPORTED_MODULE_21__/* .useLatestValue */ .E)({disabled:l,value:t,domRef:m,get textValue(){var y,S;return(S=(y=m.current)==null?void 0:y.textContent)==null?void 0:S.toLowerCase()}}),E=(0,_hooks_use_sync_refs_js__WEBPACK_IMPORTED_MODULE_4__/* .useSyncRefs */ .T)(a,m);(0,_hooks_use_iso_morphic_effect_js__WEBPACK_IMPORTED_MODULE_7__/* .useIsoMorphicEffect */ .e)(()=>{if(u.listboxState!==0||!b||u.activationTrigger===0)return;let y=(0,_utils_disposables_js__WEBPACK_IMPORTED_MODULE_20__/* .disposables */ .k)();return y.requestAnimationFrame(()=>{var S,T;(T=(S=m.current)==null?void 0:S.scrollIntoView)==null||T.call(S,{block:"nearest"})}),y.dispose},[m,b,u.listboxState,u.activationTrigger,u.activeOptionIndex]),(0,_hooks_use_iso_morphic_effect_js__WEBPACK_IMPORTED_MODULE_7__/* .useIsoMorphicEffect */ .e)(()=>i.registerOption(r,P),[P,r]);let L=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(y=>{if(l)return y.preventDefault();i.onChange(t),u.mode===0&&(i.closeListbox(),(0,_utils_disposables_js__WEBPACK_IMPORTED_MODULE_20__/* .disposables */ .k)().nextFrame(()=>{var S;return(S=u.buttonRef.current)==null?void 0:S.focus({preventScroll:!0})}))}),v=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(()=>{if(l)return i.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Nothing */ .T.Nothing);i.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Specific */ .T.Specific,r)}),c=(0,_hooks_use_tracked_pointer_js__WEBPACK_IMPORTED_MODULE_22__/* .useTrackedPointer */ .g)(),n=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(y=>c.update(y)),x=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(y=>{c.wasMoved(y)&&(l||b||i.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Specific */ .T.Specific,r,0))}),h=(0,_hooks_use_event_js__WEBPACK_IMPORTED_MODULE_6__/* .useEvent */ .z)(y=>{c.wasMoved(y)&&(l||b&&i.goToOption(_utils_calculate_active_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Focus.Nothing */ .T.Nothing))}),Q=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>({active:b,selected:R,disabled:l}),[b,R,l]);return (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .render */ .sY)({ourProps:{id:r,ref:E,role:"option",tabIndex:l===!0?void 0:-1,"aria-disabled":l===!0?!0:void 0,"aria-selected":R,disabled:void 0,onClick:L,onFocus:v,onPointerEnter:n,onMouseEnter:n,onPointerMove:x,onMouseMove:x,onPointerLeave:h,onMouseLeave:h},theirProps:p,slot:Q,defaultTag:Ye,name:"Listbox.Option"})}let et=(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .forwardRefWithAs */ .yV)(Ke),tt=(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .forwardRefWithAs */ .yV)(We),ot=(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .forwardRefWithAs */ .yV)($e),nt=(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .forwardRefWithAs */ .yV)(qe),it=(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_13__/* .forwardRefWithAs */ .yV)(Ze),Ht=Object.assign(et,{Button:tt,Label:ot,Options:nt,Option:it});
